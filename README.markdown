# The Official V2 Solutions Swift Style Guide.

This style guide outlines the coding conventions for all V2 Solutions Swift code.

The overarching goals are conciseness, readability, and simplicity.

Writing Objective-C? Check out our [Objective-C Style Guide](https://github.com/v2dev/objective-c-style-guide) too.
...
This style guide is a forked and modified version of the one from raywenderlich.com team.

See Apple’s reference material on Swift:
